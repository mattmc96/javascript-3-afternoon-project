...
//Code Here
let evenNumbers = mixedNumbers.filter(function (element, index) {
  return element % 2 === 0;
});
...
//Code Here
let myStrongest = monstersInYourPocket.filter((monstersInYourPocket) => {
...
/*
  Use a higher order method to get all the order totals after adding in the sales tax (given to you
  as a tax rate, hint: you'll need to do some multiplication). Your answer should be an array of numbers, one total for each order.
*/
